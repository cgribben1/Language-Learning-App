                ...
                input=[
                    {
                        ...
                        "content": (
                            ...
                            "Likewise, if the learner writes an unaccented common word like 'ile' for 'île', do not generate a note such as 'Use \"une île\"' if the learner already used the right article and phrase. "
                            ...
                            "But do not treat a meaning-changing noun swap as a harmless paraphrase. "
                            "If the English prompt says 'hero' and the learner writes 'homme', that changes the meaning enough that the token should not be marked correct. "
                            "In that kind of case, mark the changed noun as at least acceptable and usually wrong if the role or identity genuinely changes. "
                            ...
                            "If one note already says a meaning-bearing word like 'jeune' is missing, do not add extra notes that merely restate the same correction as 'Include jeune' or 'Put jeune before the noun'. "
                            "Prefer one concise note per underlying correction. "
